package com.spring.web.springCase.controller;
...
import com.spring.web.springCase.dao.BookDAO;
...
public class BookController 
{
    ...
    @GetMapping("BookCRUD")
    public String BookCrud(@RequestParam("sub")String sub,@RequestParam("bookid")int bookid,@RequestParam("booktitle")String booktitle,@RequestParam("price")double price,@RequestParam("Authour")String authour, RedirectAttributes ra)
    {
   	 ra.addFlashAttribute("book",new Book(bookid,booktitle,price,authour));
   	String val="";
     ...
     {
   	  bdao.insertBook(new Book(b.getBookid(),b.getBooktitle(),b.getPrice(),b.getAuthour()));
   	  return "DisplayBook";
     }
     @GetMapping("/modifyBook")
      public String modifyBook(@ModelAttribute("book")Book b)
      {
   	  bdao.modifyBook(new Book(b.getBookid(),b.getBooktitle(),b.getPrice(),b.getAuthour()));
   	  return "DisplayBook";
      }
